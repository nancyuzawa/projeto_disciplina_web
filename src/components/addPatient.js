  ...
  return (
    <div className="add-patient-content">
      ...
      <form
        ...
        className="form-add-patient"
        name="formulario"
      >
        <div className="input-dados">
          <div className="col-md-12 bg-white">
            <label
              className="label-add-patient long-label bg-white"
              htmlFor="nome"
            >
              Nome*
            </label>
          ...
          <div className="input-informacao col-md-12">
            ...
            <div className="bg-white">
              <label
                className="label-add-patient bg-white"
                htmlFor="altura"
                required
              >
                Altura*
          ...
          <div className="col-md-12 bg-white">
            <label
              className="label-add-patient long-label label-last-information bg-white"
              htmlFor="por-gordura"
            >
              % de Gordura
            </label>
